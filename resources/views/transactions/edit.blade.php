...
@section('content')
    ...
    <form action="{{ route('transactions.update', $transaction->id) }}" method="POST">
                        ...
                        <tr id="row_{{ $itemId }}">
                            ...
                            <td>
                                <input type="number" name="items[{{ $itemId }}][quantity]"
                                    value="{{ $itemData['quantity'] }}" min="1" class="form-control quantity-input">
                                <input type="hidden" name="items[{{ $itemId }}][price]"
        ...
        <div class="mb-3">
            ...
            <input type="text" name="subtotal" id="subtotal" class="form-control" value="{{ $transaction->subtotal }}"
                required readonly>
        </div>
        <div class="mb-3">
