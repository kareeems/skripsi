...
<head>
    ...
    <style>
        ...
        .navbar .dropdown-menu {
            ...
            overflow: hidden;
            /* Mencegah isi dropdown meluas */
            width: auto;
            /* Lebar otomatis sesuai isi */
            min-width: unset;
            /* Menghapus batas lebar minimum */
            right: 50px;
            /* Mengatur jarak dropdown dari tepi kanan */
        }
        ...
        .navbar .dropdown-menu .dropdown-item {
            ...
            /* Menambahkan "..." untuk teks yang terlalu panjang */
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container">
            <a class="navbar-brand" href="/">AHS Payment</a>
